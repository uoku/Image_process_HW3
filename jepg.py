...
class IDCT:
    """
    Inverse Discrete Cosine Trasformation
    """
...
class JPEG:
    ...
    def StartOfScan(self, data, hdrlen):
        data, lenchuck = RemoveFF00(data[hdrlen:])
        st = Stream(data)
        self.quantMapping[1] = 0
        self.quantMapping[2] = 0
    ...
    def decode(self):
        ...
        while True:
            ...
            if marker == 0xffd8:
                ...
                len_chunk += 2
                chuck = data[4:len_chunk]

                if marker == 0xffc4:
                    self.decodeHuffman(chuck)
                elif marker == 0xffdb:
                    self.DefineQuantizationTables(chuck)
                elif marker == 0xffc0:
                    self.BaselineDCT(chuck)
                elif marker == 0xffda:
